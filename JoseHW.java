    ...
    public static void main(String[] args) {
        ...
        try {
                ...
                System.out.println(resultSet.getString(2) + ", " +resultSet.getString(3) + ", " + resultSet.getString(4));
                    ...
                    String selectSql = "SELECT * FROM dbo.Product WHERE Price<20;";
                    statement = connection.createStatement();
                    resultSet = statement.executeQuery(selectSql);
                    System.out.println(" " );
                    // Iterate through the result set and print the attributes.
                    ...
                    String selectSql = "SELECT * FROM dbo.PurchaseOrder WHERE dbo.PurchaseOrder.CustomerID = (SELECT dbo.Customer.CustomerID FROM dbo.Customer WHERE dbo.Customer.Name = " + name + ");";
                    statement = connection.createStatement();
                    resultSet = statement.executeQuery(selectSql);
                    // Iterate through the result set and print the attributes.
                    while (resultSet.next()) {
                    ...
                    String selectSql = "SELECT dbo.PurchasedItems.ProductID FROM dob.PurchasedItems WHERE dbo.PurchasedItems.PurchaseOrderID =" + POIDnumber + ";";
                    statement = connection.createStatement();
                    resultSet = statement.executeQuery(selectSql);
                    System.out.println(String.format("List of items purchase base on purchase order ID: %s", id));
                    // Iterate through the result set and print the attributes.
                    while (resultSet.next()) {
                    ...
                    String selectSql = "SELECT dbo.Customer.Name FROM dbo.Customer WHERE dbo.Customer.CustomerID = (SELECT dbo.PurchasedItems.CustomerID FROM dbo.PurchasedItems WHERE dbo.PurchasedItemsID = "+ PurchasedItemsIDNumber + ");";
                    statement = connection.createStatement();
                    resultSet = statement.executeQuery(selectSql);
                    // Iterate through the result set and print the attributes.
                    while (resultSet.next()) {
