...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        String connectionString = "jdbc:sqlserver://josedbserver0.database.windows.net:1433;database=JoseDB;user=mydbadmin@josedbserver0;password={RobertoFernando25};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;";
